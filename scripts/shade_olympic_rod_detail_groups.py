...
XLSX_PATH = Path("/Users/tommy/GearSage/GearSage-client/pkgGear/data_raw/olympic_rod_import.xlsx")
...
def cell_text(cell, shared_strings):
    ...
    if t == "inlineStr":
        ...
        return "" if is_node is None else "".join(t.text or "" for t in is_node.iter(qn("t")))
    v = cell.find(qn("v"))
