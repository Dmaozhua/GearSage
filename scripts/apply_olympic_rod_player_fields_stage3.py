...
XLSX_PATH = ROOT / "GearSage-client/pkgGear/data_raw/olympic_rod_import.xlsx"
REPORT_PATH = ROOT / "GearSage-client/pkgGear/data_raw/olympic_rod_player_fields_stage3_report.json"
