...
const inputFile = path.resolve(__dirname, '../GearSage-client/pkgGear/data_raw/shimano_spinning_reel_test.json');
        ...
        if (item.variants && item.variants.length > 0) {
            ...
            item.variants.forEach(v => {
                ...
                variantsRows.push({
                    ...
                    "Nylon_no_m": specs.nylon_capacity || '',
                    "Nylon_lb_m": '',
                    "fluorocarbon_no_m": '',
                    "fluorocarbon_lb_m": '',
                    "pe_no_m": specs.pe_capacity || '',
