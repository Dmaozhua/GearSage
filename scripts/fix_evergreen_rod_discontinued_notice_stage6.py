...
NORMALIZED_PATH = ROOT / "GearSage-client/pkgGear/data_raw/evergreen_rod_normalized.json"
REPORT_PATH = ROOT / "GearSage-client/pkgGear/data_raw/evergreen_rod_discontinued_notice_cleanup_report.json"
