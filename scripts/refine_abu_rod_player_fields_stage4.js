...
const WHITELIST_EVIDENCE_FILE = path.join(__dirname, '../GearSage-client/pkgGear/data_raw/abu_rod_whitelist_player_evidence.json');
const REPORT_FILE = path.join(__dirname, '../GearSage-client/pkgGear/data_raw/abu_rod_player_fields_refine_report.json');
