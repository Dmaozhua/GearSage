...
export class ModerationTencentService {
  ...
  private static readonly TEXT_BIZ_TYPE_BY_SCENE: Record<ModerationScene, string | null> = {
    ...
    gear_update_request: 'gear_update_request',
    gear_feedback_content: 'gear_feedback_content',
    user_gear_content: 'user_gear_content',
    user_gear_set_content: 'user_gear_set_content',
    avatar_image: null,
  ...
  private static readonly IMAGE_BIZ_TYPE_BY_SCENE: Record<ModerationScene, string | null> = {
    ...
    user_bio: null,
    report_reason: null,
    gear_update_request: null,
    gear_feedback_content: null,
    user_gear_content: null,
    user_gear_set_content: null,
